...
namespace Entra21.ExemplosWindowsForms.Exemplo01
{
    public partial class PacientesForm : Form
    {
        ...
        public PacientesForm()
        {
            ...
            //instanciar um objeto do pacienteService que é responsável por gerenciar os dados dos pacientess
        ...
        private void AdicionarPaciente(string nome, double peso, double altura)
        {
            ...
            //Add na lista e atualizar o arquivo JSON
        ...
        {
            //Obter a lista dos pacientes para apresentar para o usuario
            var pacientes = pacienteServico.ObterTodos();

            //Remover todos os itens do datagridview, pois sera adicionado novmente
